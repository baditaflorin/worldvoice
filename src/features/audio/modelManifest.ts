...
export const modelPackSchema = z.object({
  ...
  runtime: z.string(),
  status: z.enum(['bundled', 'adapter-ready', 'external-checkpoint', 'bring-your-own', 'planned']),
  ...
  packs: [
    {
      ...
      description: 'Browser-native harmonic resynthesis used when neural packs are unavailable.',
      sizeMb: 0,
      runtime: 'Web Audio',
      status: 'bundled',
...
export async function fetchModelManifest(baseUrl: string): Promise<ModelManifest> {
